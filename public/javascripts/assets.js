...
(function() {
  ...
  App.Views.PostView = Backbone.View.extend({
    ...
    render: function() {
      ...
      $(this.el).html(window.JST['post'](this.model.toJSON()));
  ...
  App.Templates.PostListTemplate = _.template();
  ...
  window.CommentView = Backbone.View.extend({
    ...
    render: function() {
      $(this.el).html(window.JST['comment'](this.model));
      return this;
    }
  });
}).call(this);
...
window.JST['comment'] = template('<div class=\'commentAuthorImage\' style=\'float: left; margin-right: 12px\'>\n	<img src=\'http://graph.facebook.com/<%= user.facebookId %>/picture\'/>\n</div>\n<div class=\'commentAuthor\' style=\'font-weight: bold\'>\n	<%= user.name %>\n</div>\n<div class=\'commentDate\'>\n	<%= dateCreated %>\n</div>\n<div class=\'commentBody\'>\n	<%= body %>\n</div>');
window.JST['image'] = template('<div class="front">\n	<img src=\'<%= images.thumbnail.url %>\' />\n</div>\n<div class="back" style=\'background-position: -<%= xpos %>px -<%= ypos %>px\'>\n</div>\n');
window.JST['post'] = template('<div class="postDate">\n	<div class="postDateBox">\n		<div class="poster">\n			<img src="http://graph.facebook.com/<%= user.facebookId %>/picture" style="border: solid 1px #666" />\n		</div>\n		<div class="day">\n			3\n		</div>\n		<div class="monthYear">\n			Dec\n		</div>\n	</div>\n	<div class="postCommentBox">\n		<a href=\'/posts/<%= _id %>\'><%= comments.length %></a>\n	</div>\n</div>\n<div class="postContent">\n	<div class="postTitle">\n		<a href="/posts/<%= _id %>"><%= title %></a>\n	</div>\n	<div class="postCredit">\n		posted by <%= user.name %>\n	</div>\n	<div class="tags">\n		<ul class=\'taglist\'>\n			<% _.each(tagslist, function(tag) { %>\n				<li><%= tag %></li>\n			<% }); %>\n		</ul>\n	</div>\n	<div class="postBody">\n		<%= body %>\n	</div>\n</div>\n<div class="clear"></div>\n');
window.JST['postList'] = template('POSTLIST');
window.JST['tag'] = template('<a href=\'/posts/tags/<%= _id %>\'><%= _id %> <strong><%= value %></strong></a>\n ');
